...
namespace BWC\ApiExtension\Entity;
...
class ApiLoginToken extends Entity
{
    ...
    {
        $structure->table = 'bwc_api_login_token';
        $structure->shortName = 'BWC\ApiExtension:ApiLoginToken';
        $structure->primaryKey = 'login_token_id';
        $structure->columns = [
            'login_token_id' => ['type' => self::UINT, 'autoIncrement' => true, 'nullable' => true],
            'login_token' => ['type' => self::STR, 'maxLength' => 32],
