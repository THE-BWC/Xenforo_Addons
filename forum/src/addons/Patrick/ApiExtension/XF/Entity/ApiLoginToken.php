...
namespace src\addons\Patrick\ApiExtension\XF\Entity;
 ...
 */
class ApiLoginToken extends \XF\Mvc\Entity\Entity
{
    public function isValid(string $requestIp = null): bool
    {
        ...
        {
            $requestIp = Ip::convertIpStringToBinary($requestIp);
            if ($requestIp !== $this->limit_ip)
            {
                return false;
            }
    ...
    {
        $structure->table = 'ApiExtension_api_login_token';
        $structure->shortName = 'ApiExtension:ApiLoginToken';
